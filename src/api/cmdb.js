...
// 类型相关
const CMDBClassify = 'v1/cmdb/classify'
...
const CMDBRecord = 'v1/cmdb/record'
export const Record = {
  create(params) {
...
const DeviceCategoryURL = '/cmdb/device-category'
...
const USERGROUPURL = '/cmdb/user-group'
...
const ASSETRECORD = '/cmdb/asset-record'
...
const ASSETERRORLOG = '/cmdb/asset-errorLog'
...
const NETWORKURL = '/cmdb/server-network'
...
const MEMORYURL = '/cmdb/server-memory'
...
const DISKURL = '/cmdb/server-disk'
...
const NETWORKDEVICEURL = '/cmdb/network-device'
...
const BusinessUnitURL = '/cmdb/business-unit'
...
const CloudServerURL = '/cmdb/cloud-server'
...
const CloudDiskURL = '/cmdb/cloud-disk'
