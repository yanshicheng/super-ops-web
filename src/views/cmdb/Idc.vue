  ...
  <div>
    <el-card class="box-card" shadow="hover" style="margin: 20px">
      ...
      <div class="filter-container">
        <el-input v-model="pageQuerylist.search" class="filter-item" placeholder="请输入标签名称" style="width: 200px;margin-right: 10px" />
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="ref" :model="tempData" :rules="rules" class="el-form">
        ...
        <el-form-item label="区域" label-width="80px" prop="position">
          <el-input v-model="tempData.position" />
        </el-form-item>
      </el-form>
...
import { Idc as masterApi } from '@/api/cmdb'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        position: [{ required: true, message: '区域必填', trigger: 'blur' }]
      }
    }
  },
  created() {
