  ...
  <div class="data-center-tablemanage">
    ...
    <div class="tablemanage-container">
      ...
      >
        ...
        <el-table-column show-overflow-tooltip prop="title" label="名称" />
        <el-table-column show-overflow-tooltip prop="path" label="路径" />
        <el-table-column show-overflow-tooltip prop="component" label="VUE文件路径" />
        <el-table-column show-overflow-tooltip prop="name" label="路由名" />
